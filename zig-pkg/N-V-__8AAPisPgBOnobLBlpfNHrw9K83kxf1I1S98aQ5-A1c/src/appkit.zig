...
pub const NSWindow = opaque {
    ...
    const Self = @This();
    pub const NSObjectProtocolMixin_impl = gen.NSObjectProtocolMixin(Self, "NSWindow");
    pub const NSObjectInterfaceMixin_impl = gen.NSObjectInterfaceMixin(Self, "NSWindow");
