...
pub fn MTKViewInterfaceMixin(comptime Self: type, comptime class_name: [*:0]const u8) type {
    return struct {
        ...
        pub const NSViewInterfaceMixin_impl = NSViewInterfaceMixin(Self, class_name);
...
pub const MTKView = opaque {
    ...
    // pub const NSObjectProtocolMixin_impl = gen.NSObjectProtocolMixin(Self, class_name);
    pub const NSObjectInterfaceMixin_impl = gen.NSObjectInterfaceMixin(Self, class_name);
    pub const MTKViewInterfaceMixin_impl = MTKViewInterfaceMixin(Self, class_name);
};
